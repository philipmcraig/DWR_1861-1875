...
DATESEL = 15 # which day of the month?
...
cn = ax1.contour(X,Y,M,norm=pl.Normalize(972,1060),
...
obs_in = pl.delete(pres,[0,6,pres.size-5,pres.size-4,pres.size-3,pres.size-1])
crd_in = pl.delete(coords,[0,6,coords.shape[0]-5,coords.shape[0]-4,
                           coords.shape[0]-3,coords.shape[0]-1],axis=0)
