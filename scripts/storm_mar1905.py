...
DATESEL = 14 # which day of the month?
...
pres[N] = pres[N] + 0.03
S = [12,13,14,15,16,17,18,19,22,23,14,29,30,31,32,33,34,35] # south of Malin/Shields
pres[S] = pres[S] + 0.02
...
obs_in = pl.delete(pres,[0,6,8,pres.size-5,pres.size-4,pres.size-3,pres.size-2,pres.size-1])
crd_in = pl.delete(coords,[0,6,8,coords.shape[0]-5,coords.shape[0]-4,
...
err_in = pl.delete(errs,[0,6,8,errs.size-5,errs.size-4,errs.size-3,errs.size-2,errs.size-1])
