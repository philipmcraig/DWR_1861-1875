...
allfiles = glob.glob(CR20dir+year+'/*')
...
pl.title('20CRv3 ensemble mean mslp & DWR observations 20/01/1863 (08:00)',
         size=10)
#pl.tight_layout()
###############################################################################
...
pl.title('20CRv3 ensemble spread & z-scores 20/01/1863 (08:00)',size=10)
